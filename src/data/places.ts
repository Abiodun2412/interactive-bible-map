...
export const places: Place[] = [
  ...
  },
  {
    id: "troas",
    name: "Troas",
    modernName: "Alexandria Troas region, Türkiye",
    latitude: 39.75,
    longitude: 26.16,
    type: "city",
    region: "Asia Minor",
    description:
      "A port city where Paul received the vision calling him to cross into Macedonia.",
    identificationStatus: "well-established",
  },
  {
    id: "philippi",
    name: "Philippi",
    modernName: "Krinides region, Greece",
    latitude: 41.01,
    longitude: 24.29,
    type: "city",
    region: "Macedonia",
    description:
      "Roman colony where Paul and Silas ministered, Lydia believed, and the Philippian jailer was converted.",
    identificationStatus: "well-established",
  },
  {
    id: "thessalonica",
    ...
    region: "Macedonia",
    description:
      "Major Macedonian city where Paul preached in the synagogue during his second missionary journey.",
    identificationStatus: "well-established",
  },
  {
    id: "berea",
    ...
    region: "Macedonia",
    description:
      "City where many people received Paul's message and examined the Scriptures carefully.",
    identificationStatus: "well-established",
  },
  {
    id: "athens",
    ...
    region: "Achaia",
    description:
      "Major Greek city where Paul spoke at the Areopagus about the unknown God.",
    identificationStatus: "well-established",
  },
  {
    id: "corinth",
    ...
    region: "Achaia",
    description:
      "Major city where Paul spent an extended period teaching during his second missionary journey.",
    identificationStatus: "well-established",
  },
  {
    id: "ephesus",
    name: "Ephesus",
    modernName: "Selçuk region, Türkiye",
    latitude: 37.94,
    longitude: 27.34,
    type: "city",
    region: "Asia",
    description:
      "Major city of Roman Asia where Paul spent an extended period teaching and where a strong church developed.",
    identificationStatus: "well-established",
  },
  {
    id: "miletus",
    name: "Miletus",
    modernName: "Balat region, Türkiye",
    latitude: 37.53,
    longitude: 27.28,
    type: "city",
    region: "Asia",
    description:
      "Coastal city where Paul met with the elders from Ephesus on his return journey toward Jerusalem.",
    identificationStatus: "well-established",
  },
  {
    id: "myra",
    name: "Myra",
    modernName: "Demre region, Türkiye",
    latitude: 36.26,
    longitude: 29.99,
    type: "city",
    region: "Lycia",
    description:
      "A port where Paul and the other prisoners transferred to an Alexandrian ship bound westward.",
    identificationStatus: "well-established",
  },
  {
    id: "fair-havens",
    name: "Fair Havens",
    modernName: "Southern Crete",
    latitude: 34.93,
    longitude: 24.8,
    type: "site",
    region: "Crete",
    description:
      "A harbour on Crete where Paul's ship paused before continuing into dangerous weather.",
    identificationStatus: "probable",
  },
  {
    id: "malta",
    ...
    description:
      "The island where Paul and the others survived shipwreck and stayed for several months.",
    identificationStatus: "well-established",
  },
  {
    id: "syracuse",
    name: "Syracuse",
    modernName: "Syracuse, Sicily",
    latitude: 37.07,
    longitude: 15.29,
    type: "city",
    region: "Sicily",
    description:
      "A Sicilian port visited during the final stages of Paul's voyage to Rome.",
    identificationStatus: "well-established",
  },
  {
    id: "puteoli",
    ...
    region: "Italy",
    description:
      "An Italian port where Paul met believers before continuing toward Rome.",
    identificationStatus: "well-established",
  },
  {
    id: "rome",
